    ...
    <div>
      ...
      <div
        style={{
          ...
          height: "80px",
          border: "1px solid",
          backgroundColor: hover ? "orange" : "lightgray",
          lineHeight: "80px",
          textAlign: "center",
        }}
...
export function EnterInput() {
  ...
  const [message,setState] = useState("Enter 키를 눌러보세요.")

  const handleKeyUp = (e)=>{
    if(e.key === "Enter"){
    setState("Enter 입력됨 : "+e.target.value)}
  }
  ...
  return (
    <div>
      ...
      {/* {TODO} onKeyUp 연결 */}
      <input type="text" placeholder="입력 후 Enter" onKeyUp= {handleKeyUp} />
      <p>{message}</p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" placeholder="할 일 입력" value={value} onChange={handleChange} />
