...
export function Counter() {
  ...
  const reset = ()=>{
    count>=0 ? setCount(count-count) : setCount(count+(count*(-1)));
    console.log("카운트 0 :",count);
  }
  ...
  return (
    <div>
      ...
      <button onClick={plus}> +1 버튼 </button>
      <button onClick={minus}> -1 버튼 </button>
...
export function NameInput() {
  ...
  function onChagne(e) {
    console.log("text_input : ",e.target.value)
  }
